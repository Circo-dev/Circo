...
@inline Circo.Migration.check_migration(me::Union{ListItem, LinkedList}, alternatives::MigrationAlternatives, service) = begin
...
zygote(ctx) = LinkedListTest.Coordinator(CircoCore.emptycore(ctx))
